...
from seq2seq.model_utils import TokenEmbedding, PositionalEncoding
...
class TransformerEncoderLocal(nn.Module):
...
class EncoderDecoder(nn.Module):
    def __init__(self, src_vocab, trg_vocab, d_model=128, n_heads=2, num_enc_layers=6, num_dec_layers=6, ff_dim=512):
        ...
        # Decoder model
        self.decoder = TransformerDecoder(d_model=d_model, num_heads=n_heads,
...
if __name__ == '__main__':
    ...
    model_decoder = TransformerDecoder(d_model=d_model, num_heads=2, num_layers=2)
